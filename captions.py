...
url = "/standard/spencerNSF/NeuralNetworksProjectVideos/Data Science Competition/Bounding_McGee/frames/book/0001/0001.jpg"
image = Image.open(url)

# Run examples
task_prompt = '<MORE_DETAILED_CAPTION>'
print(run_example(task_prompt))
get_captions(book_dir, output_dir)
...
# results = run_example(task_prompt, text_input="woman")
# print(results)
